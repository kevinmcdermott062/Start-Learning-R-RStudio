---
title: "R/RStudio Resources for getting started learning R"
...
```
```{r, echo=FALSE}
setwd("H:/Public Health Ontario/Learn R by Kevin McDermott")
```

```{r, echo=FALSE}
#Rmarkdown source file [R Programming Resources.Rmd]("H:/Public Health Ontario/Learn R by Kevin McDermott/R Programming Resources.Rmd")
```
...
R for Hockey Analysis(in 3 Steps)
[On-line tutorial with practical applications](https://towardsdatascience.com/r-for-hockey-analysis-part-2-tidyverse-basics-5caf63aea5a5)
